...
const Topbar = () => {
    ...
    const handleToggleRegister = e =>{
        ...
        document.querySelector('.headerRegisterContainer').classList.toggle('active');
...
const handleRegister = async e =>{
    ...
    if(inputNombre.current.value && inputCel.current.value){
        if(inputCel.current.value.length === 10){
            ...
            document.querySelector('.messageRegister').innerText="Teclee 10 digitos";
        }
    }else{
      ...
      document.querySelector('.messageRegister').style.color="red";
      document.querySelector('.messageRegister').innerText="* Completa los campos";
    }
}
        ...
        <header className="header">
            ...
            <ul>
                <li className="headerRegister">
                        ...
                        <span onClick={handleToggleRegister} className="headerSpan">Registro</span>
                        <div className="headerRegisterContainer">
                            <Close onClick={handleToggleRegister}  className="headerRegisterContainerClose"  />
                           
                            <form onSubmit={handleRegister}>
                                <input className="inputRegister" ref={inputNombre} type="text" placeholder="Nombre" />
                                <input className="inputRegister inputCel" type="text" onInput={handlePress} maxLength="10" ref={inputCel}  placeholder="N&uacute;mero de Tel&eacute;fono" />
                ...
                <form onSubmit={handleSubmitSearch}>
                    <input ref={inputSearch} className="headerSearchInput" type="search" placeholder="Buscar Participantes" />
                </form>   
                </li>
            </ul>
            <HelpOutline onClick={handleToggleAdvice}   titleAccess="Ayuda" className="headerIconHelp" />
            <img className="headerImgLogin" src="https://www.licor.com/fluxsuite/images/demo.png" alt="" title="Hola Demo"/>
            <Link to="/">
            <ExitToApp titleAccess="Cerrar Sesi&oacute;n" style={{fontSize:"26px", marginTop:"5px",cursor:"pointer"}} htmlColor="tomato"/>
            </Link>
